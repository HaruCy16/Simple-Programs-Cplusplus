...
class Product
{
  ...
  public:
    Product() //CONSTRUCTOR ITO PARA MA SET DEFAULT VALUES NG PRODUCT, THIS WILL BE CHANGE ONCE MAY INPUT NA OR SINUBMIT NI USER
    {
        name = "";
        stock = 0;
        price = 0.0;
    ...
    //RETURN PRODUCT NA SINET NG USER
    string getName(){
      return name;
    }
    int getStock(){
